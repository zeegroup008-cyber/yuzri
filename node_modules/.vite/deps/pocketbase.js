...
var RealtimeService = class extends BaseService {
  ...
  async unsubscribeByTopicAndListener(e2, t2) {
    ...
    for (let e3 in s2) {
      ...
      let s3 = false;
      for (let i2 = this.subscriptions[e3].length - 1; i2 >= 0; i2--) this.subscriptions[e3][i2] === t2 && (s3 = true, delete this.subscriptions[e3][i2], this.subscriptions[e3].splice(i2, 1), (_a = this.eventSource) == null ? void 0 : _a.removeEventListener(e3, t2));
  ...
  initConnect() {
    this.disconnect(true), clearTimeout(this.connectTimeoutId), this.connectTimeoutId = setTimeout(() => {
      ...
      const t2 = e2;
      this.clientId = t2 == null ? void 0 : t2.lastEventId, this.lastSentSubscriptions = [], this.submitSubscriptions().then(() => {
  ...
  disconnect(e2 = false) {
    var _a;
    if (this.clientId && this.onDisconnect && this.onDisconnect(Object.keys(this.subscriptions)), clearTimeout(this.connectTimeoutId), clearTimeout(this.reconnectTimeoutId), this.removeAllSubscriptionListeners(), this.client.cancelRequest(this.getSubscriptionsCancelKey()), (_a = this.eventSource) == null ? void 0 : _a.close(), this.eventSource = null, this.clientId = "", this.lastSentSubscriptions = [], !e2) {
