...
export default function VPNDetailPage() {
  ...
  if (notFound || !produk) return (
    <div className="min-h-[60vh] flex items-center justify-center text-muted">
      ...
      <button onClick={() => navigate("/vpn")} className="ml-2 text-purple-2 underline">Kembali</button>
    </div>
  )
      ...
      {step === 1 && (
        <div className="space-y-5">
          <div className="bg-card border border-border rounded-2xl p-5">
            ...
            <p className="text-muted text-xs mt-1.5">Akun VPN akan diaktifkan pada email ini. Pastikan emailnya benar.</p>
          </div>
        ...
        <div className={`border rounded-2xl p-8 text-center bg-card ${
          ...
          {trxStatus === "Approved" && (
            <>
              ...
              <p className="text-muted text-sm mb-6">Detail akses VPN dikirimkan ke <span className="text-white font-medium">{email}</span></p>
              <div className="flex gap-3 justify-center">
                ...
                <button onClick={() => navigate("/vpn")} className="bg-purple hover:bg-purple-3 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors">Beli Lagi</button>
              </div>
            </>
          )}
          {trxStatus === "Rejected" && (
            <>
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button onClick={() => navigate("/vpn")} className="bg-purple hover:bg-purple-3 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors">Kembali</button>
              </div>
            </>
          )}
        </div>
