...
export default function GiftCardDetailPage() {
  ...
  if (notFound || !produk) return (
    <div className="min-h-[60vh] flex items-center justify-center text-muted">
      ...
      <button onClick={() => navigate("/giftcard")} className="ml-2 text-purple-2 underline">Kembali</button>
    </div>
  )
  ...
  const validate = () => {
    ...
    if (!paket)  e.paket  = "Pilih nominal gift card terlebih dahulu."
  ...
  return (
    <div className="px-4 md:px-8 lg:px-12 py-10">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 mb-6 flex items-center gap-4">
        ...
        <button onClick={() => navigate("/giftcard")}
      ...
      {step === 1 && (
        <div className="space-y-5">
          <div className="bg-card border border-border rounded-2xl p-5">
            <h2 className="font-semibold text-white mb-3">Alamat Email Penerima <span className="text-red-400">*</span></h2>
            ...
            <p className="text-muted text-xs mt-1.5">Kode gift card akan dikirimkan ke email ini. Pastikan emailnya benar.</p>
          </div>
        ...
        <div className={`border rounded-2xl p-8 text-center bg-card ${
          ...
          {trxStatus === "Approved" && (
            <>
              ...
              <p className="text-muted text-sm mb-1">Gift card <span className="text-white font-medium">{paket?.label}</span> telah dikirim.</p>
              <p className="text-muted text-sm mb-6">Cek email <span className="text-white font-medium">{email}</span> untuk kode gift card kamu.</p>
              <div className="flex gap-3 justify-center">
                ...
                <button onClick={() => navigate("/giftcard")} className="bg-purple hover:bg-purple-3 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors">Beli Lagi</button>
              </div>
            </>
          )}
          {trxStatus === "Rejected" && (
            <>
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button onClick={() => navigate("/giftcard")} className="bg-purple hover:bg-purple-3 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors">Kembali</button>
              </div>
            </>
          )}
        </div>
